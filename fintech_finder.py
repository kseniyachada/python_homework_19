...
candidate_database = {
    "Kseniya": ["Kseniya", "0x7Cb1b710C77168ea926E3915362e119055b27d27", "4.3", .20, "Images/kseniya.jpeg"],
    "Ash": ["Ash", "0x6797Cf6AB7da517e74b4AfA26BF0Ad9b7C43246e", "5.0", .33, "Images/ash.jpeg"],
    "Jo": ["Jo", "0x7abAc0e74e7A158fc766D82660C9893a1D8dC2E9", "4.7", .19, "Images/jo.jpeg"],
    "Kendall": ["Kendall", "0x0A40F05e079E3515623bAc7b3565b18cA647C966", "4.1", .16, "Images/kendall.jpeg"]
}

# A list of the FinTech Finder candidates first names
people = ["Kseniya", "Ash", "Jo", "Kendall"]
...
wage = candidate_database[person][1] 
...
if person_fee <= ether:
    new_balance = float(ether) - float(wage)
    st.sidebar.write("If you enter into a service agreement with", person, "for", wage, "eth, your account balance will be", new_balance, ".")
    get_people()

else:
    st.sidebar.write("With a balance of", ether, "ether, you can't buy", person, "for", wage, "eth." )
    get_people()
